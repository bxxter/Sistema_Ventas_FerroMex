...
public class editarProducto extends javax.swing.JFrame {
    ...
    public editarProducto(Producto producto) {
        ...
        cargarDatosProducto();  // Llena el formulario con datos del producto

        advertenciaNombre.setVisible(false);
        advertenciaPrecio.setVisible(false);
        advertenciaCantidad.setVisible(false);
    ...
    private void cargarDatosProducto() {
        ...
        txtCantidad.setText(String.valueOf(productoAEditar.getStock()));
        jComboBoxCategorias.setSelectedItem(productoAEditar.getCategoria());
    }

    
    // Llena el combo con las categorias
    private void llenarComboCategorias() {
        CategoriaBD dao = new CategoriaBD();
        List<Categoria> lista = dao.obtenerCategorias();

        jComboBoxCategorias.removeAllItems(); // Limpia combo antes de llenarlo

        for (Categoria cat : lista) {
            jComboBoxCategorias.addItem(cat.getNombre());
        }
    }
    ...
    private boolean validarCamposProducto() {
        ...
        if (nombre.isEmpty()) {
            advertenciaNombre.setText("Nombre no valido");
        ...
        if (jComboBoxCategorias.getSelectedIndex() == -1 || categoria == null || categoria.isEmpty()) {
    ...
    private void initComponents() {
        ...
        advertenciaPrecio = new javax.swing.JLabel();
        advertenciaCantidad = new javax.swing.JLabel();
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/inventario-disponible.png"))); // NOI18N
        ...
        advertenciaNombre.setForeground(new java.awt.Color(255, 0, 51));
        advertenciaNombre.setText("jLabel5");

        advertenciaPrecio.setForeground(new java.awt.Color(255, 0, 51));
        advertenciaPrecio.setText("jLabel5");

        advertenciaCantidad.setForeground(new java.awt.Color(255, 0, 51));
        advertenciaCantidad.setText("jLabel8");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(advertenciaPrecio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel3)
                                .addGap(18, 18, 18)
                                .addComponent(advertenciaCantidad, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            ...
                            .addComponent(jComboBoxCategorias, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        productoAEditar.setStock(cantidad);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txtPrecio.setText("");
        txtCantidad.setText("");
        jComboBoxCategorias.setSelectedItem(0);
    ...
    private javax.swing.JLabel advertenciaCantidad;
    private javax.swing.JLabel advertenciaNombre;
    private javax.swing.JLabel advertenciaPrecio;
